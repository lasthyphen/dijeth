...
import (
	...
	"github.com/lasthyphen/dijeth/plugin/evm/message"

	avalanchegoMetrics "github.com/lasthyphen/dijetsgo/api/metrics"
	coreth "github.com/lasthyphen/dijeth/chain"
	"github.com/lasthyphen/dijeth/consensus/dummy"
	"github.com/lasthyphen/dijeth/core"
	"github.com/lasthyphen/dijeth/core/state"
	"github.com/lasthyphen/dijeth/core/types"
	"github.com/lasthyphen/dijeth/eth/ethconfig"
	corethPrometheus "github.com/lasthyphen/dijeth/metrics/prometheus"
	"github.com/lasthyphen/dijeth/node"
	"github.com/lasthyphen/dijeth/params"
	"github.com/lasthyphen/dijeth/peer"
	...
	// inside of cmd/geth.
	_ "github.com/lasthyphen/dijeth/eth/tracers/js"
	_ "github.com/lasthyphen/dijeth/eth/tracers/native"
	...
	commonEng "github.com/lasthyphen/dijetsgo/snow/engine/common"

	avalancheJSON "github.com/lasthyphen/dijetsgo/utils/json"
)
...
func (vm *VM) Initialize(
	...
	if b, err := json.Marshal(vm.config); err == nil {
		log.Info("Initializing Dijeth VM", "Version", Version, "Config", string(b))
	} else {
		// Log a warning message since we have already successfully unmarshalled into the struct
		log.Warn("Problem initializing Dijeth VM", "Version", Version, "Config", string(b), "err", err)
	}
...
func (vm *VM) CreateHandlers() (map[string]*commonEng.HTTPHandler, error) {
	...
	if vm.config.DijethAdminAPIEnabled {
		adminAPI, err := newHandler("admin", NewAdminService(vm, os.ExpandEnv(fmt.Sprintf("%s_coreth_performance_%s", vm.config.DijethAdminAPIDir, primaryAlias))))
		if err != nil {
