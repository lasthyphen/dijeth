...
import (
	...
	"github.com/lasthyphen/dijeth/accounts/keystore"
	"github.com/lasthyphen/dijeth/accounts/scwallet"
	...
	"github.com/lasthyphen/dijeth/eth/tracers/logger"
...
func (s *PublicBlockChainAPI) rpcMarshalHeader(ctx context.Context, header *types.Header) map[string]interface{} {
	...
	// Note: Dijeth enforces that the difficulty of a block is always 1, such that the total difficulty of a block
